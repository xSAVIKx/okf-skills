...
`okf-go` is the shared library every skill in this registry imports. **It is the
...
```go
import "github.com/savikne/okf-skills-registry/okf-go" // package name: okf
```
...
require github.com/savikne/okf-skills-registry/okf-go v0.0.0
